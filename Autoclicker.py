...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.iconpath = ImageTk.PhotoImage(file=os.path.join("assets","link.ico"))
        self.wm_iconbitmap()
        ...
        self.min_label.grid(row=0,column=1,padx=12,sticky='nw')
        ...
        self.min_click.grid(row=1,column=1,padx=12,sticky='nw')
        # seconds box
        ...
        self.sec_label.grid(row=0,column=2,padx=12,sticky='nw')
        ...
        self.sec_click.grid(row=1,column=2,padx=12,sticky='nw')
        # milliseconds box
        ...
        self.mil_label.grid(row=0,column=3,padx=12,sticky='nw')
        ...
        self.mil_click.grid(row=1,column=3,padx=12,sticky='nw')
        # mouse buttons box
        ...
        self.mousemenu_label.grid(row=2,column=1,padx=12)
        ...
        self.mousemenu.grid(row=3,column=1,padx=12)
